                ...
                <form id="FormularioCrearVenta">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <input type="date" class="form-control" name="fecha_venta" id="fecha_venta" required value="{{ date('Y-m-d') }}">
                        </div>
                        <div class="col-md-2">
...
function cargarVentas(pagina = 1) {
    ...
    $.get('{{ url("/api/ventas") }}?' + params.toString(), function(data) {
        ...
        if (data.data.length === 0) {
            ...
            data.data.forEach(function(venta) {
                ...
                html += '<button class="btn btn-sm btn-success py-0 px-1 me-1 btn-tooltip" data-tooltip="Generar Factura" onclick="window.open(\'{{ url("/ventas/ver-factura") }}/' + venta.id + '\', \'_blank\')"><i class="bi bi-file-earmark-pdf" style="font-size:12px"></i></button>';
...
function verDetalle(id) {
    $.get('{{ url("/api/ventas") }}/' + id, function(data) {
        if (data.venta) {
