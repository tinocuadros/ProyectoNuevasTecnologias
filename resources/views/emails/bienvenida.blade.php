...
<div class="container">
    <div class="card">
        <div class="card-body">
            <img src="{{ asset('img/logo_new.png') }}" alt="VetSync" class="logo">
            
            <h3>BIENVENIDO A VETSYNC</h3>
            
            <p>
                Hola <strong>{{ $user->name }}</strong>, estamos listos para ayudarte con la gestión de tus servicios. 
    ...
    <div class="footer">
        &copy; {{ date('Y') }} VETSYNC - GESTIÓN INTEGRAL
    </div>
</div>
