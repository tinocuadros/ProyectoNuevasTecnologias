                    ...
                    <form id="perfilForm">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="cedula" class="form-control" value="<?php echo e($user->cedula); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="primer_nombre" class="form-control" value="<?php echo e($user->primer_nombre); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Segundo Nombre</label>
                                <input type="text" name="segundo_nombre" class="form-control" value="<?php echo e($user->segundo_nombre); ?>">
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="primer_apellido" class="form-control" value="<?php echo e($user->primer_apellido); ?>" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label">Segundo Apellido</label>
                                <input type="text" name="segundo_apellido" class="form-control" value="<?php echo e($user->segundo_apellido); ?>">
                            </div>
                        </div>
...
$(document).ready(function() {
    ...
    $('#cambiarContrasenaForm').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(url("/perfil/contrasena")); ?>',
            method: 'POST',
            data: $(this).serialize(),
            success: function(data) {
                if(data.success) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ProyectoNuevasTecnologias\ProyectoNuevasTecnologias\resources\views/Cuenta/MiPerfil.blade.php ENDPATH**/ ?>