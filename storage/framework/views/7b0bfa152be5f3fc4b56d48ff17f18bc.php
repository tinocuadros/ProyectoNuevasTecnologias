...
$(document).ready(function() {
    ...
    $('#FormularioCrearCliente').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(url("/api/clientes")); ?>',
            method: 'POST',
            data: formData,
    ...
    $('#FormularioEditarCliente').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(url("/api/clientes")); ?>/' + id,
            method: 'POST',
            data: formData,
            success: function(data) {
                if(data.success) {
...
function cargarClientes(pagina = 1) {
    ...
    $.get('<?php echo e(url("/api/clientes")); ?>?' + params.toString(), function(data) {
...
function verDetalle(id) {
    $.get('<?php echo e(url("/api/clientes")); ?>/' + id, function(data) {
        if (data.cliente) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\inventario\resources\views/clientes/clientes.blade.php ENDPATH**/ ?>