...
$(document).ready(function() {
    ...
    $('#FormularioCrearArticulo').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(url("/api/inventario/articulos")); ?>',
            method: 'POST',
            data: formData,
    ...
    $('#FormularioEditarArticulo').on('submit', function(e) {
        ...
        $.ajax({
            url: '<?php echo e(url("/api/inventario/articulos")); ?>/' + id,
            method: 'POST',
            data: formData,
            success: function(data) {
                if(data.success) {
...
function cargarArticulos(pagina = 1) {
    ...
    $.get('<?php echo e(url("/api/inventario/articulos")); ?>?' + params.toString(), function(data) {
...
function editarArticulo(id) {
    $.get('<?php echo e(url("/api/inventario/articulos")); ?>/' + id, function(response) {
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\ProyectoNuevasTecnologias\ProyectoNuevasTecnologias\resources\views/inventario/inventario.blade.php ENDPATH**/ ?>